...
<head>
    ...
    <style>
        * {
        ...
        .mission-statement i { color: #d4c5ad; font-size: 1.2rem; flex-shrink: 0; }
...
<div class="site-card">
    ...
    <div class="header">
        <div class="header-left">
            ...
            <h1><span class="highlight">Снаряжение</span> для СВО</h1>
        </div>
        <div class="tag">
            <i class="fas fa-truck"></i> Покупаем <i class="fas fa-heart heart"></i>
        </div>
    </div>

    <div class="mission-statement">
        <i class="fas fa-bullseye"></i>
        <span><strong>Закупаем снаряжение</strong> по высоким ценам для <strong>гуманитарной помощи</strong> в зону СВО.</span>
        <span class="badge-svo"><i class="fas fa-flag"></i> #СВО</span>
    </div>
    ...
    <div class="form-section">
        <h2><i class="fas fa-pen-to-square"></i> Отправить заявку</h2>

        <!-- FormSubmit - отправляет на почту agent0490@mail.ru -->
        <form id="sellForm" action="https://formsubmit.co/agent0490@mail.ru" method="POST">
            <!-- Скрытые поля для настройки -->
            <input type="hidden" name="_subject" value="Новая заявка на продажу снаряжения СВО" />
            <input type="hidden" name="_captcha" value="false" />
            <input type="hidden" name="_template" value="table" />
            <input type="hidden" name="_next" value="https://ваш-сайт.ру/thanks.html" />
    ...
    <div class="footer-note">
        ...
        <span><i class="fas fa-hand-holding-heart"></i> гуманитарная помощь</span>
    </div>
</div>

<script>
    // Обработка отправки формы с показом уведомления
    document.getElementById('sellForm').addEventListener('submit', function(e) {
        ...
        // Форма отправится на FormSubmit, страница перезагрузится
        // Но мы покажем уведомление перед отправкой
        feedbackMessage.textContent = '⏳ Отправляем заявку...';
        feedbackDiv.style.display = 'block';
        feedbackDiv.className = 'feedback';

        // Разрешаем отправку формы
        // Форма отправится на formsubmit.co, и пользователь увидит страницу-благодарность
